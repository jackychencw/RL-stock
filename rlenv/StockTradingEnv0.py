...
class StockTradingEnv(gym.Env):
    ...
    def _take_action(self, action):
        ...
        self.previous_networth = self.net_worth
        self.net_worth = self.balance + self.shares_held * current_price
        print(f"previous networth:{self.previous_networth}\ncurrent networth:{self.net_worth}")
    ...
    def step(self, action):
        ...
        # profits
        self.previous_networth = max(0.1, self.previous_networth)
        reward = (self.net_worth - self.previous_networth)/self.previous_networth
    ...
    def reset(self, new_df=None):
        ...
        self.previous_networth = INITIAL_ACCOUNT_BALANCE
